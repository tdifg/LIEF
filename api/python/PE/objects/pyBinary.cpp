...
void init_PE_Binary_class(py::module& m) {
  py::class_<Binary, LIEF::Binary>(m, "Binary")
    ...
    .def("hook_function",            static_cast<void (Binary::*)(const std::string&, uint64_t)>(&Binary::hook_function))
    .def("hook_function",            static_cast<void (Binary::*)(const std::string&, const std::string&, uint64_t)>(&Binary::hook_function))
